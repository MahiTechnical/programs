...
public class MaxProfitInJobSchedule {
    ...
    public static void main(String[] args) {
        MaxProfitInJobSchedule maxProfitInJobSchedule = new MaxProfitInJobSchedule();
        int [] startTime = new int[]{1,2,3,3};
        int [] endTime = new int[]{3,4,5,6};
        int [] profit = new int[]{50,10,40,70};
        System.out.println(maxProfitInJobSchedule.jobScheduling(startTime,endTime,profit));
    }
